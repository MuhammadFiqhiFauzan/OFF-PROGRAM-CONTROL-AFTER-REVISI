...
/*
 * Trusted origins untuk akses lokal + dev tunnel.
 * - Localhost untuk akses lokal.
 * - Wildcard untuk dev tunnel umum (VS Code devtunnels, ngrok, cloudflare, localtunnel).
 * - Tambahan eksplisit via env TRUSTED_ORIGINS (pisahkan koma) bila tunnel memakai domain lain.
 * Hanya untuk validasi origin Better Auth; bukan perubahan role/permission.
 */
